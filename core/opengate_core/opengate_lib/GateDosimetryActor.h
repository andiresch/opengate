...
#ifndef GateDosimetryActor_h
#define GateDosimetryActor_h
...
class GateDosimetryActor : public GateVActor {

public:
  // Constructor
  GateDosimetryActor(py::dict &user_info);
